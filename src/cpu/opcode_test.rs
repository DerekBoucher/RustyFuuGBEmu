...
fn _0x45() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdLIntoB_0x45.into()]));
            cpu.hl.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x46() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![
                Opcode::LdMemoryHLIntoB_0x46.into(),
                0xFF,
            ]));
            cpu.hl.lo = 0x01;
            return cpu;
...
fn _0x47() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdAIntoB_0x47.into()]));
            cpu.af.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x48() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdBIntoC_0x48.into()]));
            cpu.bc.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x49() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdCIntoC_0x49.into()]));
            cpu.bc.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x4a() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdDIntoC_0x4A.into()]));
            cpu.de.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x4b() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdEIntoC_0x4B.into()]));
            cpu.de.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x4c() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdHIntoC_0x4C.into()]));
            cpu.hl.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x4d() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdLIntoC_0x4D.into()]));
            cpu.hl.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x4e() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![
                Opcode::LdMemoryHLIntoC_0x4E.into(),
                0xFF,
            ]));
            cpu.hl.lo = 0x01;
            return cpu;
...
fn _0x4f() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdAIntoC_0x4F.into()]));
            cpu.af.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x50() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdBIntoD_0x50.into()]));
            cpu.bc.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x51() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdCIntoD_0x51.into()]));
            cpu.bc.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x52() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdDIntoD_0x52.into()]));
            cpu.de.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x53() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdEIntoD_0x53.into()]));
            cpu.de.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x54() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdHIntoD_0x54.into()]));
            cpu.hl.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x55() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdLIntoD_0x55.into()]));
            cpu.hl.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x56() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![
                Opcode::LdMemoryHLIntoD_0x56.into(),
                0xFF,
            ]));
            cpu.hl.lo = 0x01;
            return cpu;
...
fn _0x57() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdAIntoD_0x57.into()]));
            cpu.af.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x58() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdBIntoE_0x58.into()]));
            cpu.bc.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x59() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdCIntoE_0x59.into()]));
            cpu.bc.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x5a() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdDIntoE_0x5A.into()]));
            cpu.de.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x5b() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdEIntoE_0x5B.into()]));
            cpu.de.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x5c() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdHIntoE_0x5C.into()]));
            cpu.hl.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x5d() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdLIntoE_0x5D.into()]));
            cpu.hl.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x5e() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![
                Opcode::LdMemoryHLIntoE_0x5E.into(),
                0xFF,
            ]));
            cpu.hl.lo = 0x01;
            return cpu;
...
fn _0x60() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdBIntoH_0x60.into()]));
            cpu.bc.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x61() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdCIntoH_0x61.into()]));
            cpu.bc.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x62() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdDIntoH_0x62.into()]));
            cpu.de.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x63() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdEIntoH_0x63.into()]));
            cpu.de.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x64() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdHIntoH_0x64.into()]));
            cpu.hl.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x65() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdLIntoH_0x65.into()]));
            cpu.hl.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x67() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdAIntoH_0x67.into()]));
            cpu.af.hi = 0x10;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x68() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdBIntoL_0x68.into()]));
            cpu.bc.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x69() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdCIntoL_0x69.into()]));
            cpu.bc.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x6a() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdDIntoL_0x6A.into()]));
            cpu.de.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x6b() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdEIntoL_0x6B.into()]));
            cpu.de.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x6c() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdHIntoL_0x6C.into()]));
            cpu.hl.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x6d() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdLIntoL_0x6D.into()]));
            cpu.hl.lo = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
...
fn _0x6e() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![
                Opcode::LdMemoryHLIntoL_0x6E.into(),
                0xFF,
            ]));
            cpu.hl.lo = 0x01;
            return cpu;
...
fn _0x6f() {
    let test_cases: Vec<TestCase> = vec![TestCase {
        initial_state: || -> LR35902 {
            let mut cpu = LR35902::new(mock::Memory::new(vec![Opcode::LdAIntoL_0x6F.into()]));
            cpu.af.hi = 0x40;
            return cpu;
        },
        expected_state: || -> LR35902 {
